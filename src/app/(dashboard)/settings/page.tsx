...
export default async function SettingsPage() {
  ...
  const me = await prisma.user.findUnique({
    ...
    select: {
      ...
      // Chapter groups businesses, so it is read through the business relation.
      business: { select: { addressLine1: true, addressLine2: true, suburb: true, state: true, postcode: true, chapter: { select: { name: true } } } },
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-6">
      ...
      <ProfileSettings
        me={{
          ...me,
          chapterName: me.business?.chapter?.name ?? null,
