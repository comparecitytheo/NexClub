...
export type EffectiveUser = {
  ...
  name: string;
  email: string;
  // UserRole, not string: every consumer (scope.ts, ai-context.ts, the role
  // guards) takes the enum, and both sources of this value — the session user
  // and the impersonated member loaded from Prisma — already are one.
  role: UserRole;
